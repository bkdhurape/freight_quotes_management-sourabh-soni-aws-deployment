...
class TestProductGetById(APITestCase):
    ...
    def test_product_get_by_id(self):
        ...
        self.maxDiff = None
        self.assertEqual(ProductRequestParams.get_product_by_id_params_set(), api_response_json['data'])

    def test_product_get_by_id_with_invalid_entity_id(self):
        api_url = ProductRequestParams.api_url() + '/api/v1/entity/9999999999/product/' + str(self.product_id) + '/'
        response = self.client.get(api_url, format='json')
        api_response_json = json.loads(response.content)
    ...
    def test_product_get_by_invalid_id(self):
