...
class TestProductDeleteById(APITestCase):
    ...
    def test_product_delete_by_id(self):
        ...
        self.assertEqual('Product removed successfully', api_response_json['message'])
        self.assertEqual(None, api_response_json['data'])


    def test_product_delete_with_invalid_entity_id(self):
        # Add product
        api_url = ProductRequestParams.api_url() + '/api/v1/entity/99999999999999/product/' + str(self.product_id) + '/'
        response = self.client.delete(api_url)
        api_response_json = json.loads(response.content)
    ...
    def test_product_delete_by_invalid_id(self):
        ...
        self.assertEqual({}, api_response_json['data'])
        self.assertEqual('F02011', api_response_json['code'])
