...
class TestCompanyCreate(APITestCase):
    ...
    def test_company_create(self):
        ...
        expected_api_data = {'name': ['company with this name already exists.'], 'industry': {'0': ['"consumer_goods_or_fmcg_2" is not a valid choice.']}, 'business_activity': {'0': ['"manufacturer_2" is not a valid choice.']}}
        actual_api_data = api_response_json['data']
        api_data = True if expected_api_data == actual_api_data else False
        self.assertEqual(expected_api_data, actual_api_data)
        status = 'PASS' if api_data else 'FAIL'
        ...
        expected_api_data = {'name': ['company with this name already exists.'], 'industry': ['This field may not be null.'], 'business_activity': ['This field may not be null.']}
        actual_api_data = api_response_json['data']
        api_data = True if expected_api_data == actual_api_data else False
        self.assertEqual(expected_api_data, actual_api_data)
        status = 'PASS' if api_data else 'FAIL'
