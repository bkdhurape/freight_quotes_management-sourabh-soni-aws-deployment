...
class TestEntityGetAll(APITestCase):
    ...
    def test_entity_get_all(self):
        ...
        self.assertEqual('Entity data retrieved successfully.', api_response_json['message'])
        self.maxDiff = None
        self.assertEqual(EntityRequestParams.get_list_of_entity_params_set(), api_response_json['data'])
