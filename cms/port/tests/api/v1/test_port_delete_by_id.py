...
class TestPortDeleteById(APITestCase):
    ...
    def test_port_delete_by_id(self):
        ...
        self.assertEqual('Port removed successfully', api_response_json['message'])
        self.assertEqual(None, api_response_json['data'])


    def test_port_delete_by_invalid_id(self):
