...
class TestInvitedVendorDelete(APITestCase):
    ...
    def test_invited_vendor_delete(self):
        invite_vendor_delete_api_url = CustomerParams.api_url() + '/api/v1/company/' + str(self.customer_company_id) + '/customer/' + str(self.customer_id) + '/clients/' + str(self.invited_vendor_id) + '/'
        response = self.client.delete(invite_vendor_delete_api_url, format='json')
        api_response_json = json.loads(response.content)

        self.assertEqual(200, response.status_code)
        self.assertEqual('success', api_response_json['status'])
        self.assertEqual('Vendor invite delete successfully', api_response_json['message'])
        self.assertEqual(None, api_response_json['data'])
        self.assertEqual(200, api_response_json['code'])


    def test_invited_vendor_delete_invalid_id(self):
        invite_vendor_delete_api_url = CustomerParams.api_url() + '/api/v1/company/' + str(self.customer_company_id) + '/customer/' + str(self.customer_id) + '/clients/99999999999/'
        response = self.client.delete(invite_vendor_delete_api_url, format='json')
        api_response_json = json.loads(response.content)

        self.assertEqual(400, response.status_code)
        self.assertEqual('failure', api_response_json['status'])
        self.assertEqual('You cannot delete this vendor.', api_response_json['message'])
        self.assertEqual({}, api_response_json['data'])
        self.assertEqual('F0187', api_response_json['code'])


    def test_invited_vendor_delete_with_invalid_company_id(self):
        invite_vendor_delete_api_url = CustomerParams.api_url() + '/api/v1/company/9999999999999/customer/' + str(self.customer_id) + '/clients/' + str(self.invited_vendor_id) + '/'
        response = self.client.delete(invite_vendor_delete_api_url, format='json')
        api_response_json = json.loads(response.content)
    ...
    def test_invited_vendor_delete_with_invalid_customer_id(self):
        invite_vendor_delete_api_url = CustomerParams.api_url() + '/api/v1/company/' + str(self.customer_company_id) + '/customer/999999999999/clients/' + str(self.invited_vendor_id) + '/'
        response = self.client.delete(invite_vendor_delete_api_url, format='json')
        api_response_json = json.loads(response.content)
