...
class TestBranchGetById(TestCase):
    ...
    def test_branch_get_by_id(self):

        api_url_get_by_id = BranchRequestParams.api_url() + 'api/v1/company/' + \
            str(self.company_id)+'/branch/' + \
            str(self.branch_id)+'/'
    ...
    def test_branch_get_company_not_found(self):
    ...
    def test_branch_data_not_found(self):
        ...
        ) + 'api/v1/company/'+str(self.company_id)+'/branch/9999999999/'
